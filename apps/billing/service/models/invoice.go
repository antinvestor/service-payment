...
type Invoice struct {
	...
	SubtotalAmount  decimal.NullDecimal `gorm:"type:numeric(29,9);not null"            json:"subtotal_amount"`
	DiscountAmount  decimal.NullDecimal `gorm:"type:numeric(29,9);not null"            json:"discount_amount"`
	CreditAmount    decimal.NullDecimal `gorm:"type:numeric(29,9);not null"            json:"credit_amount"`
	TotalAmount     decimal.NullDecimal `gorm:"type:numeric(29,9);not null"            json:"total_amount"`
...
type InvoiceLine struct {
	...
	DiscountAmount decimal.NullDecimal `gorm:"type:numeric(29,9)"                   json:"discount_amount"`
	CreditAmount   decimal.NullDecimal `gorm:"type:numeric(29,9)"                   json:"credit_amount"`
	NetAmount      decimal.NullDecimal `gorm:"type:numeric(29,9);not null"          json:"net_amount"`
	Currency       string              `gorm:"type:varchar(10);not null"            json:"currency"`
