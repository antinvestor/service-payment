...
require (
	...
	buf.build/gen/go/antinvestor/payment/connectrpc/go v1.19.1-20251104183854-d9b3d91e6972.2
	buf.build/gen/go/antinvestor/payment/protocolbuffers/go v1.36.10-20251104183854-d9b3d91e6972.1
